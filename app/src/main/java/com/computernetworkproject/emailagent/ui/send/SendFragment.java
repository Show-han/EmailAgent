...
public class SendFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Button button_163 = view.findViewById(R.id.button_send_163);
        Button button_qq = view.findViewById(R.id.button_send_qq);
        ...
        button_163.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Navigation.findNavController(v).navigate(R.id.action_nav_send_to_selectAccountFragment, bundle);
            }
        });
